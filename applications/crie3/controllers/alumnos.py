...
#busca las alumnos y asesor que coincidan
...
#busca el numero de docentes en cada escuela
    ...
    return dict(contador=contador, formulario=formulario, contar_esc = contar_esc,contar_doc = contar_doc, asesor=asesor,asesor2=asesor2)
